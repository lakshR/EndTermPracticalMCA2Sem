  ...
  public static void main(String[] args) {
    try {
      ...
      if (myObj.createNewFile()) 
      {
        ...
        FileWriter myWriter = new FileWriter("Pankaj Bhatt");
        
        System.out.println("My Name is Pankaj Bhatt.I am persuing MCA from GEHU Dehradun.");
        ...
        String line = null;
        FileReader fileReader = new FileReader("Pankaj Bhatt");
